  ...
  <section class="csv-translator" aria-label="Find a CSV error guide" data-nosnippet>
    ...
    <div v-if="!count" class="csv-empty">
      ...
      <div class="cta-actions">
        ...
        <a class="cta-secondary csv-button" href="https://meetings-eu1.hubspot.com/patrick-olson?utm_source=mysuite&utm_medium=csv-tool&utm_campaign=import-fix&utm_content=translator" target="_blank" rel="noopener">Book a free 30-minute import fix</a>
      </div>
    </div>
