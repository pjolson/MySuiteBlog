...
rule(/(?:too many|more than|mismatch|incorrect number of|different number of).*columns/, 'GEN-08')
...
rule(/member items/, 'ASM-01', /missing|required|at least|enter|select|no member/)
...
rule(/customlist/, 'LST-03', /\bid\b|\bname\b|column|mapped/)
